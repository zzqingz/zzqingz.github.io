...
(() => {
  ...
  $('startButton').onclick=()=>{$('cover').hidden=true;$('demoContent').hidden=false;goModule(0);window.scrollTo(0,0);$('nextButton').focus({preventScroll:true});};
